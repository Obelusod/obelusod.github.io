...
访问[中国高等教育学生信息网（学信网）](https://www.chsi.com.cn)，并登录网站
...
!!! info annotate "教育许可证说明"
    ...
    在教育许可证中，可以查看许可证 ID（License ID）、许可证有效期（Valid through）及其包含的所有可免费使用的产品。(1)
    
    !!! warning ""

        **每个教育许可证仅有 1 年的有效期，如果仍然大学在读，可以在授权到期前后（会有邮件提醒）重新申请续期！**
